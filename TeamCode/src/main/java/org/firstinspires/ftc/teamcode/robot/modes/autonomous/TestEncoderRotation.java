...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "360 rotation Encoder", group = "Autonomous")
@Disabled
public class TestEncoderRotation extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        try {
            ...
            robot.queueUpRotateClockwise(180, "Testing rotation");
            robot.queueUpWait(10000, "Waiting 10 seconds");
            robot.queueUpRotateClockwise(180, "Testing rotation");

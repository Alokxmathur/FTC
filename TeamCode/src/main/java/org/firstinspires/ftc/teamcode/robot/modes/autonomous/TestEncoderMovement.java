...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Test 80cm travel Encoder", group = "Autonomous")
@Disabled
public class TestEncoderMovement extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        try {
            ...
            Match.log("--------> Starting 80cm autonomous");
            robot.queueUpTravel(800, "Testing 80cm movement");

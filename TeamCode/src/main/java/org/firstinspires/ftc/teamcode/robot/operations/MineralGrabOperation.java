...
public class MineralGrabOperation extends DriveTrainOperation {
    ...
    public boolean anyMineralsPickedUp() {
        return distalMineralPickedUp || proximalMineralPickedUp;
    }
    ...
    public MineralGrabOperation(double travel, double speed, String title) {

...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Facing Depot", group = "Autonomous")
@Disabled
public class AutonomousFacingDepot extends Autonomous {
    @Override
    public void runOpMode() {
        super.setExtraSampling(false);
        super.runOpMode();
    }
}
